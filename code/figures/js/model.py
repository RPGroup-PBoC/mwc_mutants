...
p_fc.line(x='c', y='ref_fc', source=source, color=pboc['blue'], line_width=1,
          legend='reference strain')
p_fc.line(x='c', y='mut_fc', source=source, color=pboc['red'], line_width=1,
          legend='mutant strain')
p_fc.circle(x='c', y='mut_fc', source=source, view=view,
            color=pboc['red'], line_width=1, size=5, legend='mutant strain')


# Plot the data collapse
p_bohr.line(bohr_range, (1 + np.exp(-bohr_range))**-1, color='black', 
            line_width=1, legend='master curve')
p_bohr.circle(x='mut_bohr', y='mut_fc', source=source, view=view,
            color=pboc['red'], size=5, legend='mutant strain')
...
p_delBohr.line(x='c', y='mut_delta_bohr', source=source, color=pboc['red'], 
            legend='mutant strain', line_width=1)
