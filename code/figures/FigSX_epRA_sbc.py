...
# Load the samples
sbc_samples = pd.read_csv('../../data/csv/epRA_sbc.csv')
...
plt.tight_layout()
plt.savefig('../../figures/FigSX_epRA_sbc_dists.pdf', bbox_inches='tight')
...
plt.tight_layout()
plt.savefig('../../figures/FigSX_epRA_sbc_sensitivity.pdf')
...
plt.tight_layout()
plt.savefig('../../figures/FigSX_epRA_sbc_rank.pdf', bbox_inches='tight')