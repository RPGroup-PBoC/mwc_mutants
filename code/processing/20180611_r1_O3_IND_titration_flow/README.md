---
status: Accepted
notes:  This is accepted with the caveat that mutations F164T and Q294V are actually in the O1 or Oid operator. These data have been removed from the data set and have been retaken. 
---

# 2018-06-11 IND IPTG titration

## Purpose
This experiment measured the fold-change of inducer binding mutants F164T, Q294V, Q294K, and Q294R over a range of IPTG concentration
...
| `Manuel 03 - D6` | `pZS4*5-mCherry` | `galK<>25-O3+11-YFP, ybcN<>3*1-RBS1027_LacI_F164T` | `HG105` | `F164T` | `IND`|
| `Manuel 03 - D8` | `pZS4*5-mCherry` | `galK<>25-O3+11-YFP, ybcN<>3*1-RBS1027_LacI_Q294V` | `HG105` | `Q294V` | `IND`|
| `Manuel 03 - E4` | `pZS4*5-mCherry` | `galK<>25-O3+11-YFP, ybcN<>3*1-RBS1027_LacI_Q294K` | `HG105` | `Q294K` | `IND`|
| `Manuel 04 - I4` | `pZS4*5-mCherry` | `galK<>25-O3+11-YFP, ybcN<>3*1-RBS1027_LacI_Q294R` | `HG105` | `Q294R` | `IND`|
...
**Induction Profile**
![](output/20180611_r1_IND_fold_change_curve.png)
