---
status: Rejected
notes: Not sure what happened, but fold-change oscillates between < 0 and > 1.5. Need to retake this data set I believe. 
---

# 2018-12-21 Y20I-Q294K IPTG titration

## Purpose
This experiment measures the fold-change in gene expression for freshly transduced Y20I Q294K double mutant with O2+11 regulatory sequence.
