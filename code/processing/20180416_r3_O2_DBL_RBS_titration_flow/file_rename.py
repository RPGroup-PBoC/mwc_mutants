...
files = glob.glob('../../../data/flow/fcs/20180416_r3/{0}*r*.fcs'.format(FCS_PATTERN,
                                                           RUN_NO))
...
for i, col in enumerate(col_groups):
    for j, samp in enumerate(col):
        ...
        # Rename the fcs file.
        os.rename(samp, '../../../data/flow/fcs/20180416_r3/{0}.fcs'.format(name))
