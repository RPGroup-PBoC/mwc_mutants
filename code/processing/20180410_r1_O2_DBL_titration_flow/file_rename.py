...
ROWS = ('auto', 'delta', 'Q21A-F164T', 'Q21A-Q294V', 'Y20I-F164T', 'Y20I-Q294K', 'Y20I-Q294V')
COLS = (0, 0.1, 5, 10, 25, 50, 75, 100, 250, 500, 1000, 5000)


# Get the names of the files.
files = glob.glob('../../../data/flow/fcs/20180410_r1/{0}*r{1}*.fcs'.format(FCS_PATTERN,
                                                           RUN_NO))
...
for i, col in enumerate(col_groups):
    for j, samp in enumerate(col):
        ...
        # Rename the fcs file.
        os.rename(samp, '../../../data/flow/fcs/20180410_r1/{0}.fcs'.format(name))
