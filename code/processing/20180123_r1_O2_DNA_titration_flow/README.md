...
| `Manuel 03 - D3` | `pZS4*5-mCherry` | `galK<>25-O2+11-YFP, ybcN<>3*1-RBS1027_LacI_Y20I` | `HG105` | `Y20I` | `DNA`|
| `Manuel 03 - D4` | `pZS4*5-mCherry` | `galK<>25-O2+11-YFP, ybcN<>3*1-RBS1027_LacI_Q21A` | `HG105` | `Q21A` | `DNA`|
| `Manuel 03 - D5` | `pZS4*5-mCherry` | `galK<>25-O2+11-YFP, ybcN<>3*1-RBS1027_LacI_Q21M` | `HG105` | `Q21M` | `DNA`|
...
**Induction Profile**
![](output/20180123_r1_DNA_fold_change_curve.png)

**WT titration**
![](output/20180123_r1_DNA_WT_titration.png)
