---
status: Accepted 
notes: Something went wrong with the pipetting of the 75µM IPTG concentration and was dropped.
---
# 2019-03-08 Y20I, F164T, and Q294V IPTG titration

## Purpose
This experiment measures the fold-change in gene expression for the DNA
binding mutant Y20I and inducer binding mutants F164T/Q294V across several
repressor copy numbers. The two inducer binding mutants were measured only with
260 repressors per cell. 
...
**Induction Profile**
![](output/20190308_r1_fold_change_curve.png)
