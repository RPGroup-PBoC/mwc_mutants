...
| `Manuel 04 - B4` | `pZS4*5-mCherry` | `galK<>25-O2+11-YFP, ybcN<>3*1-RBS1027_LacI_Q21M_F164T` | `HG105` | `Q21M-F164T` | `DBL`|
| `Manuel 04 - B5` | `pZS4*5-mCherry` | `galK<>25-O2+11-YFP, ybcN<>3*1-RBS1027_LacI_Q21M_Q294K` | `HG105` | `Q21M-Q294K` | `DBL`|
| `Manuel 04 - B6` | `pZS4*5-mCherry` | `galK<>25-O2+11-YFP, ybcN<>3*1-RBS1027_LacI_Q21M_Q294V` | `HG105` | `Q21M-Q294V` | `DBL`|
...
**Induction Profile**
![](output/20180416_r3_DBL_fold_change_curve.png)
