---
status: Accepted
notes:  WT titration profile is shifted rightward from the predicted induction profile.
---

# 2018-04-09 IND IPTG titration
...
| `Manuel 03 - D6` | `pZS4*5-mCherry` | `galK<>25-O2+11-YFP, ybcN<>3*1-RBS1027_LacI_F164T` | `HG105` | `F164T` | `IND`|
| `Manuel 03 - D8` | `pZS4*5-mCherry` | `galK<>25-O2+11-YFP, ybcN<>3*1-RBS1027_LacI_Q294V` | `HG105` | `Q294V` | `IND`|
...
**Induction Profile**
![](output/20180409_r1_IND_fold_change_curve.png)

**WT titration**
![](output/20180409_r1_IND_WT_titration.png)
