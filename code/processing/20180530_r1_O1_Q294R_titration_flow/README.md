...
# 2018-05-30 DBL IPTG titration

## Purpose
This experiment measured the fold-change of Q294R  across varying IPTG concentrations.
...
| `Manuel 02 - D8` | `pZS4*5-mCherry` | `galK<>25-O2+11-YF` | `HG105` | `delta`| `delta`|
| `Manuel 04 - I2` | `pZS4*5-mCherry` | `galK<>25-O1+11-YFP, ybcN<>3*1-RBS1027_LacI_Q294R` | `HG105` | `Q294R` | `IND`|
...
**Induction Profile**
![](output/20180530_r1_INDfold_change_curve.png)
