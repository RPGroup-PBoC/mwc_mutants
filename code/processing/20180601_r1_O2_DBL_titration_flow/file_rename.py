...
OPERATOR = 'O2'
FCS_PATTERN = 'RP2018-06-01'

savedir = '../../../data/flow/csv/'

# Define the order of rows and the cols.
ROWS = ('auto', 'delta', 'Q21A-Q294K', 'Q21A-Q294K', 'Q21A-Q294K',
        'Y20I-Q294K', 'Y20I-Q294K', 'Y20I-Q294K')
COLS = (0, 0.1, 5, 10, 25, 50, 75, 100, 250, 500, 1000, 5000)
RUN_NO = (1, 1, 1, 2, 3, 1, 2, 3)
CLASS = ('DBL', 'DBL', 'DBL', 'DBL', 'DBL', 'DBL')

# Get the names of the files.
files = glob.glob('../../../data/flow/fcs/{0}*r1*.fcs'.format(FCS_PATTERN))
files = np.sort(files)
