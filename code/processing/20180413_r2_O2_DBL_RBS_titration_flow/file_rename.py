...
RUN_NO = 2
OPERATOR = 'O2'
FCS_PATTERN = 'RP2018-04-1'

savedir = '../../../data/flow/csv/'

# Define the order of rows and the cols.
ROWS = ('auto', 'delta', 'Q21M-F164T', 'Q21M-Q294K', 'Q21M-Q294V')
COLS = (0, 0.1, 5, 10, 25, 50, 75, 100, 250, 500, 1000, 5000)


# Get the names of the files.
files = glob.glob('../../../data/flow/fcs/20180413_r2/{0}*r{1}*.fcs'.format(FCS_PATTERN,
                                                           RUN_NO))
...
for i, col in enumerate(col_groups):
    for j, samp in enumerate(col):
        ...
        # Rename the fcs file.
        os.rename(samp, '../../../data/flow/fcs/20180413_r2/{0}.fcs'.format(name))
