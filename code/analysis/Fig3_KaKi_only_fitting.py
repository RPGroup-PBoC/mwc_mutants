...
model_code = mut.bayes.assemble_StanModelCode('../stan/KaKi_fitting.stan', '../stan/functions.stan')
...
new_names = {'{}.{}'.format(n, i): '{}.{}'.format(n, m) for m, i in IND_idx.items() for n in ['Ka', 'Ki', 'sigma']}
...
samples_df.to_csv('../../data/csv/Fig{}_{}_KaKi_only_samples.csv'.format(FIG_NO, OPERATOR), index=False)
samples_stats.to_csv('../../data/csv/Fig{}_{}_KaKi_only_stats.csv'.format(FIG_NO, OPERATOR), index=False)
