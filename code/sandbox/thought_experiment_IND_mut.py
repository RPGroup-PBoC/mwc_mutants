...
ax[0].plot(c_0 / Ka_0, mut_fc[0, :, 0], '-', color=colors[2],  label='mutant 1')
ax[0].plot(c_0[::50]/ Ka_0, mut_fc[0, ::50, 0], 'o', color=colors[2], label='__nolegend__')
ax[0].plot(c_0/ Ka_0, mut_fc[1, :, 1], '-', color=colors[4],  label='mutant 2')
ax[0].plot(c_0[::50] / Ka_0, mut_fc[1, ::50, 1], 'o', color=colors[4], label='__nolegend__')
...
plt.tight_layout()
plt.savefig('thought_experiment_IND_kaki.pdf', bbox_inches='tight')